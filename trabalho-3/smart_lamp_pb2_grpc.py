...
import smart_lamp_pb2 as smart__lamp__pb2
...
class LampadaStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ligarLampada = channel.unary_unary(
                ...
                request_serializer=smart__lamp__pb2.LampadaStatus.SerializeToString,
                response_deserializer=smart__lamp__pb2.LampadaStatus.FromString,
                )
...
def add_LampadaServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ligarLampada': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=smart__lamp__pb2.LampadaStatus.FromString,
                    response_serializer=smart__lamp__pb2.LampadaStatus.SerializeToString,
            ),
...
class Lampada(object):
    ...
    def ligarLampada(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/Lampada/ligarLampada',
            smart__lamp__pb2.LampadaStatus.SerializeToString,
            smart__lamp__pb2.LampadaStatus.FromString,
